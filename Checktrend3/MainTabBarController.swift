...
class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        var navigationController3 = UINavigationController(rootViewController: tabView3)
        var navigationController4 = UINavigationController(rootViewController: tabView4)
